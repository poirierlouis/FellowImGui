import {type AfterViewInit, Component, type ElementRef, HostListener, ViewChild} from "@angular/core";
...
@Component({
  selector: "fig-readme",
  imports: [RouterLink, MatIcon, MatTooltip, MatFabButton],
...
export class ReadmeComponent implements AfterViewInit {
  ...
  private get $steps(): HTMLMediaElement[] {
    return [this.step01, this.step02, this.step03, this.step04, this.step05].map(
      (step) => step.nativeElement as HTMLMediaElement,
    );
  }
